function classifier = printResultCoast(inputImageTest, testNum)
...
if(minDist1 == classifier)
    ...
    str = ['Test image ', num2str(testNum),' of class Coast has been assigned to class Forest'];
    title(str);
...
if(minDist2 == classifier)
    imshow(inputImageTest);
    str = ['Test image ', num2str(testNum),' of class Coast has been assigned to class Coast'];
    title(str);
end

if(minDist3 == classifier)
    imshow(inputImageTest);
    str = ['Test image ', num2str(testNum),' of class Coast has been assigned to class Insidecity'];
    title(str);
end
